...
#if ((defined(_WINSOCK_DEPRECATED_NO_WARNINGS) || defined(BUILD_WINDOWS)) &&   \
     !defined(_WINSOCK_DEPRECATE_WARNINGS)) ||                                 \
    defined(MIDL_PASS)
#define _WINSOCK_DEPRECATED_BY(replacement)
#else
#define _WINSOCK_DEPRECATED_BY(replacement)                                    \
  __declspec(deprecated("Use " replacement                                     \
                        " instead or define _WINSOCK_DEPRECATED_NO_WARNINGS "  \
...
#else
#define _WINSOCK_DEPRECATED                                                    \
  __declspec(deprecated("Define _WINSOCK_DEPRECATED_NO_WARNINGS to disable "   \
...
#define MSG_PUSH_IMMEDIATE                                                     \
  0x20 /* Do not delay receive request completion if data is available */
...
typedef int(CALLBACK *LPCONDITIONPROC)(
    IN LPWSABUF lpCallerId, IN LPWSABUF lpCallerData, IN OUT LPQOS lpSQOS,
...
typedef void(CALLBACK *LPWSAOVERLAPPED_COMPLETION_ROUTINE)(
    IN DWORD dwError, IN DWORD cbTransferred, IN LPWSAOVERLAPPED lpOverlapped,
    IN DWORD dwFlags);
...
#pragma region Desktop Family or OneCore Family
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_SYSTEM)
typedef struct _WINSOCK_DEPRECATED_BY("WSASERVICECLASSINFOW")
...
typedef struct _WINSOCK_DEPRECATED_BY("WSANAMESPACE_INFOW")
    _WSANAMESPACE_INFOA {
  GUID NSProviderId;
  DWORD dwNameSpace;
  BOOL fActive;
...
typedef struct _WINSOCK_DEPRECATED_BY("WSANAMESPACE_INFOEXW")
...
WINSOCK_API_LINKAGE
_Must_inspect_result_ SOCKET WSAAPI accept(
    _In_ SOCKET s, _Out_writes_bytes_opt_(*addrlen) struct sockaddr FAR *addr,
    _Inout_opt_ int FAR *addrlen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef _Must_inspect_result_ SOCKET(WSAAPI *LPFN_ACCEPT)(
    _In_ SOCKET s, _Out_writes_bytes_opt_(*addrlen) struct sockaddr FAR *addr,
    _Inout_opt_ int FAR *addrlen);
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_BIND)(_In_ SOCKET s,
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_CLOSESOCKET)(_In_ SOCKET s);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI connect(_In_ SOCKET s,
                   _In_reads_bytes_(namelen) const struct sockaddr FAR *name,
                   _In_ int namelen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_CONNECT)(_In_ SOCKET s,
                                  _In_reads_bytes_(namelen)
                                      const struct sockaddr FAR *name,
                                  _In_ int namelen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI ioctlsocket(_In_ SOCKET s, _In_ long cmd,
                       _When_(cmd != FIONREAD, _Inout_)
                           _When_(cmd == FIONREAD, _Out_) u_long FAR *argp);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_IOCTLSOCKET)(_In_ SOCKET s, _In_ long cmd,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI getsockopt(_In_ SOCKET s, _In_ int level, _In_ int optname,
...
typedef int(WSAAPI *LPFN_GETSOCKOPT)(
    _In_ SOCKET s, _In_ int level, _In_ int optname,
    _Out_writes_bytes_(*optlen) char FAR *optval, _Inout_ int FAR *optlen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef u_long(WSAAPI *LPFN_HTONL)(_In_ u_long hostlong);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef u_short(WSAAPI *LPFN_HTONS)(_In_ u_short hostshort);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef unsigned long(WSAAPI *LPFN_INET_ADDR)(_In_ const char FAR *cp);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef char FAR *(WSAAPI *LPFN_INET_NTOA)(_In_ struct in_addr in);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if !defined(NO_EXTRA_HTON_FUNCTIONS) && !defined(__midl) &&                   \
    (defined(INCL_EXTRA_HTON_FUNCTIONS) || NTDDI_VERSION >= NTDDI_WIN8)
/*
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_LISTEN)(_In_ SOCKET s, _In_ int backlog);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef u_long(WSAAPI *LPFN_NTOHL)(_In_ u_long netlong);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef u_short(WSAAPI *LPFN_NTOHS)(_In_ u_short netshort);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI recv(_In_ SOCKET s,
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_RECV)(_In_ SOCKET s,
...
typedef int(WSAAPI *LPFN_RECVFROM)(
    _In_ SOCKET s, _Out_writes_bytes_to_(len, return) char FAR *buf,
    _In_ int len, _In_ int flags,
    _Out_writes_bytes_to_opt_(*fromlen, *fromlen) struct sockaddr FAR *from,
    _Inout_opt_ int FAR *fromlen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI select(_In_ int nfds, _Inout_opt_ fd_set FAR *readfds,
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_SELECT)(_In_ int nfds, _Inout_opt_ fd_set FAR *readfds,
                                 _Inout_opt_ fd_set FAR *writefds,
                                 _Inout_opt_ fd_set FAR *exceptfds,
                                 _In_opt_ const struct timeval FAR *timeout);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI send(_In_ SOCKET s, _In_reads_bytes_(len) const char FAR *buf,
                _In_ int len, _In_ int flags);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_SEND)(_In_ SOCKET s,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI sendto(_In_ SOCKET s, _In_reads_bytes_(len) const char FAR *buf,
                  _In_ int len, _In_ int flags,
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_SENDTO)(_In_ SOCKET s,
                                 _In_reads_bytes_(len) const char FAR *buf,
                                 _In_ int len, _In_ int flags,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI setsockopt(_In_ SOCKET s, _In_ int level, _In_ int optname,
                      _In_reads_bytes_opt_(optlen) const char FAR *optval,
                      _In_ int optlen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_SETSOCKOPT)(_In_ SOCKET s, _In_ int level,
                                     _In_ int optname,
                                     _In_reads_bytes_(optlen)
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI shutdown(_In_ SOCKET s, _In_ int how);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_SHUTDOWN)(_In_ SOCKET s, _In_ int how);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
_Must_inspect_result_ SOCKET WSAAPI socket(_In_ int af, _In_ int type,
                                           _In_ int protocol);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef _Must_inspect_result_
SOCKET(WSAAPI *LPFN_SOCKET)(_In_ int af, _In_ int type, _In_ int protocol);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
struct hostent FAR *WSAAPI gethostbyaddr(_In_reads_bytes_(len)
                                             const char FAR *addr,
                                         _In_ int len, _In_ int type);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef struct hostent FAR *(WSAAPI *LPFN_GETHOSTBYADDR)(
    _In_reads_bytes_(len) const char FAR *addr, _In_ int len, _In_ int type);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI gethostname(_Out_writes_bytes_(namelen) char FAR *name,
                       _In_ int namelen);
...
typedef int(WSAAPI *LPFN_GETHOSTNAME)(
    _Out_writes_bytes_(namelen) char FAR *name, _In_ int namelen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI GetHostNameW(_Out_writes_(namelen) PWSTR name, _In_ int namelen);

#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_GETHOSTNAMEW)(_Out_writes_(namelen) PWSTR name,
                                       _In_ int namelen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
struct servent FAR *WSAAPI getservbyport(_In_ int port,
                                         _In_opt_z_ const char FAR *proto);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef struct servent FAR *(WSAAPI *LPFN_GETSERVBYPORT)(
    _In_ int port, _In_opt_z_ const char FAR *proto);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
struct servent FAR *WSAAPI getservbyname(_In_z_ const char FAR *name,
                                         _In_opt_z_ const char FAR *proto);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef struct servent FAR *(WSAAPI *LPFN_GETSERVBYNAME)(
    _In_z_ const char FAR *name, _In_opt_z_ const char FAR *proto);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
struct protoent FAR *WSAAPI getprotobynumber(_In_ int number);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef struct protoent FAR *(WSAAPI *LPFN_GETPROTOBYNUMBER)(_In_ int number);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
struct protoent FAR *WSAAPI getprotobyname(_In_z_ const char FAR *name);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
_Must_inspect_result_ int WSAAPI WSAStartup(_In_ WORD wVersionRequested,
                                            _Out_ LPWSADATA lpWSAData);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef _Must_inspect_result_ int(WSAAPI *LPFN_WSASTARTUP)(
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
void WSAAPI WSASetLastError(_In_ int iError);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
FARPROC
WSAAPI
WSASetBlockingHook(_In_ FARPROC lpBlockFunc);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef FARPROC(WSAAPI *LPFN_WSASETBLOCKINGHOOK)(_In_ FARPROC lpBlockFunc);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
HANDLE
WSAAPI
WSAAsyncGetServByName(_In_ HWND hWnd, _In_ u_int wMsg,
                      _In_z_ const char FAR *name, _In_z_ const char FAR *proto,
...
typedef HANDLE(WSAAPI *LPFN_WSAASYNCGETSERVBYNAME)(
    _In_ HWND hWnd, _In_ u_int wMsg, _In_z_ const char FAR *name,
    _In_z_ const char FAR *proto, _Out_writes_bytes_(buflen) char FAR *buf,
    _In_ int buflen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
HANDLE
WSAAPI
WSAAsyncGetServByPort(_In_ HWND hWnd, _In_ u_int wMsg, _In_ int port,
...
typedef HANDLE(WSAAPI *LPFN_WSAASYNCGETSERVBYPORT)(
    _In_ HWND hWnd, _In_ u_int wMsg, _In_ int port, _In_ const char FAR *proto,
    _Out_writes_bytes_(buflen) char FAR *buf, _In_ int buflen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
HANDLE
WSAAPI
WSAAsyncGetProtoByName(_In_ HWND hWnd, _In_ u_int wMsg,
                       _In_z_ const char FAR *name,
                       _Out_writes_bytes_(buflen) char FAR *buf,
                       _In_ int buflen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
HANDLE
WSAAPI
WSAAsyncGetProtoByNumber(_In_ HWND hWnd, _In_ u_int wMsg, _In_ int number,
                         _Out_writes_bytes_(buflen) char FAR *buf,
                         _In_ int buflen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
typedef HANDLE(WSAAPI *LPFN_WSAASYNCGETPROTOBYNUMBER)(
    _In_ HWND hWnd, _In_ u_int wMsg, _In_ int number,
    _Out_writes_bytes_(buflen) char FAR *buf, _In_ int buflen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
HANDLE
WSAAPI
WSAAsyncGetHostByName(_In_ HWND hWnd, _In_ u_int wMsg,
                      _In_z_ const char FAR *name,
                      _Out_writes_bytes_(buflen) char FAR *buf,
                      _In_ int buflen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
HANDLE
WSAAPI
WSAAsyncGetHostByAddr(_In_ HWND hWnd, _In_ u_int wMsg,
                      _In_reads_bytes_(len) const char FAR *addr, _In_ int len,
                      _In_ int type, _Out_writes_bytes_(buflen) char FAR *buf,
                      _In_ int buflen);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef HANDLE(WSAAPI *LPFN_WSAASYNCGETHOSTBYADDR)(
    _In_ HWND hWnd, _In_ u_int wMsg, _In_reads_bytes_(len) const char FAR *addr,
    _In_ int len, _In_ int type, _Out_writes_bytes_(buflen) char FAR *buf,
    _In_ int buflen);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
_WINSOCK_DEPRECATED
WINSOCK_API_LINKAGE
int WSAAPI WSACancelAsyncRequest(_In_ HANDLE hAsyncTaskHandle);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSACANCELASYNCREQUEST)(_In_ HANDLE hAsyncTaskHandle);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
_WINSOCK_DEPRECATED_BY("WSAEventSelect()")
WINSOCK_API_LINKAGE
int WSAAPI WSAAsyncSelect(_In_ SOCKET s, _In_ HWND hWnd, _In_ u_int wMsg,
                          _In_ long lEvent);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSAASYNCSELECT)(_In_ SOCKET s, _In_ HWND hWnd,
                                         _In_ u_int wMsg, _In_ long lEvent);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
_Must_inspect_result_ SOCKET WSAAPI WSAAccept(
    _In_ SOCKET s,
    _Out_writes_bytes_to_opt_(*addrlen, *addrlen) struct sockaddr FAR *addr,
    _Inout_opt_ LPINT addrlen, _In_opt_ LPCONDITIONPROC lpfnCondition,
    _In_opt_ DWORD_PTR dwCallbackData);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef _Must_inspect_result_ SOCKET(WSAAPI *LPFN_WSAACCEPT)(
    _In_ SOCKET s,
    _Out_writes_bytes_to_opt_(*addrlen, *addrlen) struct sockaddr FAR *addr,
    _Inout_opt_ LPINT addrlen, _In_opt_ LPCONDITIONPROC lpfnCondition,
    _In_opt_ DWORD_PTR dwCallbackData);
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
BOOL WSAAPI WSACloseEvent(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef BOOL(WSAAPI *LPFN_WSACLOSEEVENT)(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAConnect(_In_ SOCKET s,
                      _In_reads_bytes_(namelen) const struct sockaddr FAR *name,
                      _In_ int namelen, _In_opt_ LPWSABUF lpCallerData,
                      _Out_opt_ LPWSABUF lpCalleeData, _In_opt_ LPQOS lpSQOS,
...
BOOL PASCAL WSAConnectByNameW(
    _In_ SOCKET s, _In_ LPWSTR nodename, _In_ LPWSTR servicename,
    _Inout_opt_ LPDWORD LocalAddressLength,
    _Out_writes_bytes_to_opt_(*LocalAddressLength, *LocalAddressLength)
        LPSOCKADDR LocalAddress,
    _Inout_opt_ LPDWORD RemoteAddressLength,
    _Out_writes_bytes_to_opt_(*RemoteAddressLength, *RemoteAddressLength)
...
BOOL PASCAL WSAConnectByNameA(
    _In_ SOCKET s, _In_ LPCSTR nodename, _In_ LPCSTR servicename,
    _Inout_opt_ LPDWORD LocalAddressLength,
    _Out_writes_bytes_to_opt_(*LocalAddressLength, *LocalAddressLength)
        LPSOCKADDR LocalAddress,
    _Inout_opt_ LPDWORD RemoteAddressLength,
...
BOOL PASCAL WSAConnectByList(
    _In_ SOCKET s, _In_ PSOCKET_ADDRESS_LIST SocketAddress,
    _Inout_opt_ LPDWORD LocalAddressLength,
    _Out_writes_bytes_to_opt_(*LocalAddressLength, *LocalAddressLength)
        LPSOCKADDR LocalAddress,
    _Inout_opt_ LPDWORD RemoteAddressLength,
...
WINSOCK_API_LINKAGE
int WSAAPI WSADuplicateSocketA(_In_ SOCKET s, _In_ DWORD dwProcessId,
                               _Out_ LPWSAPROTOCOL_INFOA lpProtocolInfo);

WINSOCK_API_LINKAGE
int WSAAPI WSADuplicateSocketW(_In_ SOCKET s, _In_ DWORD dwProcessId,
...
typedef int(WSAAPI *LPFN_WSADUPLICATESOCKETA)(
    _In_ SOCKET s, _In_ DWORD dwProcessId,
    _Out_ LPWSAPROTOCOL_INFOA lpProtocolInfo);
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAEnumNetworkEvents(_In_ SOCKET s, _In_ WSAEVENT hEventObject,
                                _Out_ LPWSANETWORKEVENTS lpNetworkEvents);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSAENUMNETWORKEVENTS)(
    _In_ SOCKET s, _In_ WSAEVENT hEventObject,
    _Out_ LPWSANETWORKEVENTS lpNetworkEvents);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
int WSAAPI WSAEnumProtocolsA(_In_opt_ LPINT lpiProtocols,
                             _Out_writes_bytes_to_opt_(*lpdwBufferLength,
                                                       *lpdwBufferLength)
                                 LPWSAPROTOCOL_INFOA lpProtocolBuffer,
                             _Inout_ LPDWORD lpdwBufferLength);

WINSOCK_API_LINKAGE
int WSAAPI WSAEnumProtocolsW(_In_opt_ LPINT lpiProtocols,
                             _Out_writes_bytes_to_opt_(*lpdwBufferLength,
                                                       *lpdwBufferLength)
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAEventSelect(_In_ SOCKET s, _In_opt_ WSAEVENT hEventObject,
                          _In_ long lNetworkEvents);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSAEVENTSELECT)(_In_ SOCKET s,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
BOOL WSAAPI WSAGetOverlappedResult(_In_ SOCKET s,
                                   _In_ LPWSAOVERLAPPED lpOverlapped,
                                   _Out_ LPDWORD lpcbTransfer, _In_ BOOL fWait,
                                   _Out_ LPDWORD lpdwFlags);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef BOOL(WSAAPI *LPFN_WSAGETOVERLAPPEDRESULT)(
    _In_ SOCKET s, _In_ LPWSAOVERLAPPED lpOverlapped,
    _Out_ LPDWORD lpcbTransfer, _In_ BOOL fWait, _Out_ LPDWORD lpdwFlags);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
_WINSOCK_DEPRECATED
WINSOCK_API_LINKAGE
BOOL WSAAPI WSAGetQOSByName(_In_ SOCKET s, _In_ LPWSABUF lpQOSName,
                            _Out_ LPQOS lpQOS);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef BOOL(WSAAPI *LPFN_WSAGETQOSBYNAME)(_In_ SOCKET s,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAHtonl(_In_ IN SOCKET s, _In_ IN u_long hostlong,
                    _Out_ OUT u_long FAR *lpnetlong);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSAHTONL)(_In_ SOCKET s, _In_ u_long hostlong,
                                   _Out_ u_long FAR *lpnetlong);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAHtons(_In_ IN SOCKET s, _In_ IN u_short hostshort,
                    _Out_ OUT u_short FAR *lpnetshort);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSAHTONS)(_In_ SOCKET s, _In_ u_short hostshort,
...
WINSOCK_API_LINKAGE
int WSAAPI WSAIoctl(
    _In_ SOCKET s, _In_ DWORD dwIoControlCode,
    _In_reads_bytes_opt_(cbInBuffer) LPVOID lpvInBuffer, _In_ DWORD cbInBuffer,
    _Out_writes_bytes_to_opt_(cbOutBuffer, *lpcbBytesReturned)
        LPVOID lpvOutBuffer,
    _In_ DWORD cbOutBuffer, _Out_ LPDWORD lpcbBytesReturned,
...
SOCKET
WSAAPI
WSAJoinLeaf(_In_ SOCKET s,
            _In_reads_bytes_(namelen) const struct sockaddr FAR *name,
            _In_ int namelen, _In_opt_ LPWSABUF lpCallerData,
            _Out_opt_ LPWSABUF lpCalleeData, _In_opt_ LPQOS lpSQOS,
            _In_opt_ LPQOS lpGQOS, _In_ DWORD dwFlags);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSANtohl(_In_ SOCKET s, _In_ u_long netlong,
                    _Out_ u_long FAR *lphostlong);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSANTOHL)(_In_ SOCKET s, _In_ u_long netlong,
                                   _Out_ u_long FAR *lphostlong);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSANtohs(_In_ SOCKET s, _In_ u_short netshort,
                    _Out_ u_short FAR *lphostshort);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSANTOHS)(_In_ SOCKET s, _In_ u_short netshort,
                                   _Out_ u_short FAR *lphostshort);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
typedef int(WSAAPI *LPFN_WSARECV)(
    _In_ SOCKET s, _In_reads_(dwBufferCount) LPWSABUF lpBuffers,
    _In_ DWORD dwBufferCount, _Out_opt_ LPDWORD lpNumberOfBytesRecvd,
    _Inout_ LPDWORD lpFlags, _Inout_opt_ LPWSAOVERLAPPED lpOverlapped,
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
int WSAAPI WSARecvDisconnect(_In_ SOCKET s,
                             _In_opt_ __out_data_source(NETWORK)
                                 LPWSABUF lpInboundDisconnectData);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSARECVDISCONNECT)(
    _In_ SOCKET s, __out_data_source(NETWORK) LPWSABUF lpInboundDisconnectData);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
int WSAAPI WSARecvFrom(
    ...
    _Out_writes_bytes_to_opt_(*lpFromlen,
                              *lpFromlen) struct sockaddr FAR *lpFrom,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
BOOL WSAAPI WSAResetEvent(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef BOOL(WSAAPI *LPFN_WSARESETEVENT)(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_TYPEDEFS */

#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI
WSASend(_In_ SOCKET s, _In_reads_(dwBufferCount) LPWSABUF lpBuffers,
...
WINSOCK_API_LINKAGE
int WSAAPI
WSASendMsg(_In_ SOCKET Handle, _In_ LPWSAMSG lpMsg, _In_ DWORD dwFlags,
...
WINSOCK_API_LINKAGE
int WSAAPI WSASendDisconnect(_In_ SOCKET s,
                             _In_opt_ LPWSABUF lpOutboundDisconnectData);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef int(WSAAPI *LPFN_WSASENDDISCONNECT)(
    _In_ SOCKET s, _In_opt_ LPWSABUF lpOutboundDisconnectData);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
int WSAAPI
WSASendTo(_In_ SOCKET s, _In_reads_(dwBufferCount) LPWSABUF lpBuffers,
          _In_ DWORD dwBufferCount, _Out_opt_ LPDWORD lpNumberOfBytesSent,
          _In_ DWORD dwFlags,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
BOOL WSAAPI WSASetEvent(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef BOOL(WSAAPI *LPFN_WSASETEVENT)(_In_ WSAEVENT hEvent);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
_Must_inspect_result_ SOCKET WSAAPI
WSASocketA(_In_ int af, _In_ int type, _In_ int protocol,
           _In_opt_ LPWSAPROTOCOL_INFOA lpProtocolInfo, _In_ GROUP g,
           _In_ DWORD dwFlags);

WINSOCK_API_LINKAGE
_Must_inspect_result_ SOCKET WSAAPI
WSASocketW(_In_ int af, _In_ int type, _In_ int protocol,
           _In_opt_ LPWSAPROTOCOL_INFOW lpProtocolInfo, _In_ GROUP g,
           _In_ DWORD dwFlags);
#ifdef UNICODE
...
typedef _Must_inspect_result_
SOCKET(WSAAPI *LPFN_WSASOCKETA)(_In_ int af, _In_ int type, _In_ int protocol,
                                _In_opt_ LPWSAPROTOCOL_INFOA lpProtocolInfo,
                                _In_ GROUP g, _In_ DWORD dwFlags);

typedef _Must_inspect_result_
SOCKET(WSAAPI *LPFN_WSASOCKETW)(_In_ int af, _In_ int type, _In_ int protocol,
...
DWORD
WSAAPI
WSAWaitForMultipleEvents(_In_ DWORD cEvents,
                         _In_reads_(cEvents) const WSAEVENT FAR *lphEvents,
                         _In_ BOOL fWaitAll, _In_ DWORD dwTimeout,
                         _In_ BOOL fAlertable);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef DWORD(WSAAPI *LPFN_WSAWAITFORMULTIPLEEVENTS)(
    _In_ DWORD cEvents, _In_reads_(cEvents) const WSAEVENT FAR *lphEvents,
    _In_ BOOL fWaitAll, _In_ DWORD dwTimeout, _In_ BOOL fAlertable);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
INT WSAAPI WSAAddressToStringA(
    ...
    _In_ DWORD dwAddressLength, _In_opt_ LPWSAPROTOCOL_INFOA lpProtocolInfo,
...
INT WSAAPI WSAAddressToStringW(
    _In_reads_bytes_(dwAddressLength) LPSOCKADDR lpsaAddress,
    _In_ DWORD dwAddressLength, _In_opt_ LPWSAPROTOCOL_INFOW lpProtocolInfo,
    _Out_writes_to_(*lpdwAddressStringLength, *lpdwAddressStringLength)
...
WINSOCK_API_LINKAGE
INT WSAAPI WSAStringToAddressA(_In_ LPSTR AddressString, _In_ INT AddressFamily,
                               _In_opt_ LPWSAPROTOCOL_INFOA lpProtocolInfo,
                               _Out_writes_bytes_to_(*lpAddressLength,
                                                     *lpAddressLength)
                                   LPSOCKADDR lpAddress,
                               _Inout_ LPINT lpAddressLength);

WINSOCK_API_LINKAGE
INT WSAAPI WSAStringToAddressW(_In_ LPWSTR AddressString,
...
typedef INT(WSAAPI *LPFN_WSASTRINGTOADDRESSA)(
    _In_ LPSTR AddressString, _In_ INT AddressFamily,
    _In_opt_ LPWSAPROTOCOL_INFOA lpProtocolInfo,
    _Out_writes_bytes_to_(*lpAddressLength, *lpAddressLength)
        LPSOCKADDR lpAddress,
    _Inout_ LPINT lpAddressLength);

typedef INT(WSAAPI *LPFN_WSASTRINGTOADDRESSW)(
    _In_ LPWSTR AddressString, _In_ INT AddressFamily,
    _In_opt_ LPWSAPROTOCOL_INFOW lpProtocolInfo,
    _Out_writes_bytes_to_(*lpAddressLength, *lpAddressLength)
        LPSOCKADDR lpAddress,
    _Inout_ LPINT lpAddressLength);
...
WINSOCK_API_LINKAGE
INT WSAAPI WSALookupServiceBeginA(_In_ LPWSAQUERYSETA lpqsRestrictions,
                                  _In_ DWORD dwControlFlags,
                                  _Out_ LPHANDLE lphLookup);

WINSOCK_API_LINKAGE
INT WSAAPI WSALookupServiceBeginW(_In_ LPWSAQUERYSETW lpqsRestrictions,
                                  _In_ DWORD dwControlFlags,
                                  _Out_ LPHANDLE lphLookup);
#ifdef UNICODE
...
typedef INT(WSAAPI *LPFN_WSALOOKUPSERVICEBEGINA)(
    _In_ LPWSAQUERYSETA lpqsRestrictions, _In_ DWORD dwControlFlags,
    _Out_ LPHANDLE lphLookup);

typedef INT(WSAAPI *LPFN_WSALOOKUPSERVICEBEGINW)(
    _In_ LPWSAQUERYSETW lpqsRestrictions, _In_ DWORD dwControlFlags,
    _Out_ LPHANDLE lphLookup);
#ifdef UNICODE
...
WINSOCK_API_LINKAGE
INT WSAAPI WSALookupServiceNextA(_In_ HANDLE hLookup, _In_ DWORD dwControlFlags,
                                 _Inout_ LPDWORD lpdwBufferLength,
                                 _Out_writes_bytes_to_(*lpdwBufferLength,
                                                       *lpdwBufferLength)
                                     LPWSAQUERYSETA lpqsResults);

WINSOCK_API_LINKAGE
INT WSAAPI WSALookupServiceNextW(_In_ HANDLE hLookup, _In_ DWORD dwControlFlags,
                                 _Inout_ LPDWORD lpdwBufferLength,
                                 _Out_writes_bytes_to_opt_(*lpdwBufferLength,
                                                           *lpdwBufferLength)
...
typedef INT(WSAAPI *LPFN_WSALOOKUPSERVICENEXTA)(
    _In_ HANDLE hLookup, _In_ DWORD dwControlFlags,
    _Inout_ LPDWORD lpdwBufferLength,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
INT WSAAPI WSANSPIoctl(_In_ HANDLE hLookup, _In_ DWORD dwControlCode,
                       _In_reads_bytes_opt_(cbInBuffer) LPVOID lpvInBuffer,
                       _In_ DWORD cbInBuffer,
                       _Out_writes_bytes_to_opt_(cbOutBuffer,
                                                 *lpcbBytesReturned)
                           LPVOID lpvOutBuffer,
                       _In_ DWORD cbOutBuffer, _Out_ LPDWORD lpcbBytesReturned,
...
typedef INT(WSAAPI *LPFN_WSANSPIOCTL)(
    ...
    _In_reads_bytes_opt_(cbInBuffer) LPVOID lpvInBuffer, IN DWORD cbInBuffer,
    _Out_writes_bytes_to_opt_(cbOutBuffer, *lpcbBytesReturned)
        LPVOID lpvOutBuffer,
    IN DWORD cbOutBuffer, _Out_ LPDWORD lpcbBytesReturned,
    _In_opt_ LPWSACOMPLETION lpCompletion);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
#endif //(_WIN32_WINNT >= 0x0501)
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
INT WSAAPI WSALookupServiceEnd(_In_ HANDLE hLookup);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef INT(WSAAPI *LPFN_WSALOOKUPSERVICEEND)(_In_ HANDLE hLookup);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
INT WSAAPI
WSAInstallServiceClassA(_In_ LPWSASERVICECLASSINFOA lpServiceClassInfo);
WINSOCK_API_LINKAGE
INT WSAAPI
WSAInstallServiceClassW(_In_ LPWSASERVICECLASSINFOW lpServiceClassInfo);
#ifdef UNICODE
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
INT WSAAPI WSARemoveServiceClass(_In_ LPGUID lpServiceClassId);
#endif /* INCL_WINSOCK_API_PROTOTYPES */

#if INCL_WINSOCK_API_TYPEDEFS
typedef INT(WSAAPI *LPFN_WSAREMOVESERVICECLASS)(_In_ LPGUID lpServiceClassId);
#endif /* INCL_WINSOCK_API_TYPEDEFS */
...
WINSOCK_API_LINKAGE
INT WSAAPI
WSAGetServiceClassInfoA(_In_ LPGUID lpProviderId, _In_ LPGUID lpServiceClassId,
                        _Inout_ LPDWORD lpdwBufSize,
                        _Out_writes_bytes_to_(*lpdwBufSize, *lpdwBufSize)
...
WINSOCK_API_LINKAGE
INT WSAAPI
WSAGetServiceClassInfoW(_In_ LPGUID lpProviderId, _In_ LPGUID lpServiceClassId,
                        _Inout_ LPDWORD lpdwBufSize,
                        _Out_writes_bytes_to_(*lpdwBufSize, *lpdwBufSize)
...
typedef INT(WSAAPI *LPFN_WSAGETSERVICECLASSINFOA)(
    _In_ LPGUID lpProviderId, _In_ LPGUID lpServiceClassId,
    _Inout_ LPDWORD lpdwBufSize,
    _Out_writes_bytes_to_(*lpdwBufSize, *lpdwBufSize)
        LPWSASERVICECLASSINFOA lpServiceClassInfo);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                   \
...
WINSOCK_API_LINKAGE
INT WSAAPI WSAEnumNameSpaceProvidersA(_Inout_ LPDWORD lpdwBufferLength,
                                      _Out_writes_bytes_to_(*lpdwBufferLength,
                                                            *lpdwBufferLength)
                                          LPWSANAMESPACE_INFOA lpnspBuffer);

WINSOCK_API_LINKAGE
INT WSAAPI WSAEnumNameSpaceProvidersW(_Inout_ LPDWORD lpdwBufferLength,
                                      _Out_writes_bytes_to_(*lpdwBufferLength,
                                                            *lpdwBufferLength)
...
_WINSOCK_DEPRECATED_BY("WSAEnumNameSpaceProvidersW()")
WINSOCK_API_LINKAGE
INT WSAAPI WSAEnumNameSpaceProvidersExA(_Inout_ LPDWORD lpdwBufferLength,
                                        _Out_writes_bytes_to_(*lpdwBufferLength,
                                                              *lpdwBufferLength)
                                            LPWSANAMESPACE_INFOEXA lpnspBuffer);

WINSOCK_API_LINKAGE
INT WSAAPI WSAEnumNameSpaceProvidersExW(_Inout_ LPDWORD lpdwBufferLength,
                                        _Out_writes_bytes_to_(*lpdwBufferLength,
                                                              *lpdwBufferLength)
...
WINSOCK_API_LINKAGE
_Success_(return == 0) INT WSAAPI
    WSAGetServiceClassNameByClassIdA(_In_ LPGUID lpServiceClassId,
                                     _Out_writes_bytes_to_(*lpdwBufferLength,
                                                           *lpdwBufferLength)
                                         LPSTR lpszServiceClassName,
                                     _Inout_ LPDWORD lpdwBufferLength);
...
WINSOCK_API_LINKAGE
_Success_(return == 0) INT WSAAPI
    WSAGetServiceClassNameByClassIdW(_In_ LPGUID lpServiceClassId,
                                     _Out_writes_bytes_to_(*lpdwBufferLength,
                                                           *lpdwBufferLength)
                                         LPWSTR lpszServiceClassName,
                                     _Inout_ LPDWORD lpdwBufferLength);
...
WINSOCK_API_LINKAGE
INT WSAAPI WSASetServiceA(_In_ LPWSAQUERYSETA lpqsRegInfo,
                          _In_ WSAESETSERVICEOP essoperation,
                          _In_ DWORD dwControlFlags);

WINSOCK_API_LINKAGE
INT WSAAPI WSASetServiceW(_In_ LPWSAQUERYSETW lpqsRegInfo,
                          _In_ WSAESETSERVICEOP essoperation,
                          _In_ DWORD dwControlFlags);
#ifdef UNICODE
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef INT(WSAAPI *LPFN_WSASETSERVICEA)(_In_ LPWSAQUERYSETA lpqsRegInfo,
                                         _In_ WSAESETSERVICEOP essoperation,
                                         _In_ DWORD dwControlFlags);

typedef INT(WSAAPI *LPFN_WSASETSERVICEW)(_In_ LPWSAQUERYSETW lpqsRegInfo,
                                         _In_ WSAESETSERVICEOP essoperation,
                                         _In_ DWORD dwControlFlags);
#ifdef UNICODE
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
INT WSAAPI WSAProviderConfigChange(_Inout_ LPHANDLE lpNotificationHandle,
                                   _Inout_opt_ LPWSAOVERLAPPED lpOverlapped,
...
#if INCL_WINSOCK_API_PROTOTYPES
WINSOCK_API_LINKAGE
int WSAAPI WSAPoll(_Inout_ LPWSAPOLLFD fdArray, _In_ ULONG fds,
                   _In_ INT timeout);
#endif /* INCL_WINSOCK_API_PROTOTYPES */
#endif // (_WIN32_WINNT >= 0x0600)
...
#define SOCK_NOTIFY_REGISTER_EVENT_IN                                          \
  0x01 // Input is available from the socket without blocking.
#define SOCK_NOTIFY_REGISTER_EVENT_OUT                                         \
  0x02 // Output can be provided to the socket without blocking.
#define SOCK_NOTIFY_REGISTER_EVENT_HANGUP                                      \
  0x04 // The socket connection has been terminated.
...
// be provided.
//
#define SOCK_NOTIFY_EVENT_IN                                                   \
  SOCK_NOTIFY_REGISTER_EVENT_IN // Input is available from the socket without
                                // blocking.
#define SOCK_NOTIFY_EVENT_OUT                                                  \
  SOCK_NOTIFY_REGISTER_EVENT_OUT // Output can be provided to the socket without
                                 // blocking.
#define SOCK_NOTIFY_EVENT_HANGUP                                               \
  SOCK_NOTIFY_REGISTER_EVENT_HANGUP   // The socket connection has been
                                      // terminated.
...
//
// Socket notification registration operations. One operation must be supplied
// at a time.
//
// A SOCK_NOTIFY_OP_DISABLE operation will not destroy the underlying
// structures.
//
// A SOCK_NOTIFY_OP_REMOVE operation will cause a SOCK_NOTIFY_REMOVE
// notification to be delivered when the operation completes successfully.
//
...
//    - One of SOCK_NOTIFY_TRIGGER_PERSISTENT or SOCK_NOTIFY_TRIGGER_ONESHOT
//    must be supplied
//    - One of SOCK_NOTIFY_TRIGGER_LEVEL or SOCK_NOTIFY_TRIGGER_EDGE must be
//    supplied
//
// SOCK_NOTIFY_TRIGGER_PERSISTENT is not compatible with
// SOCK_NOTIFY_TRIGGER_ONESHOT. SOCK_NOTIFY_TRIGGER_LEVEL is not compatible with
// SOCK_NOTIFY_TRIGGER_EDGE.
//
#define SOCK_NOTIFY_TRIGGER_ONESHOT                                            \
  0x01 // The registration will be disabled (not removed) upon delivery of the
       // next notification.
#define SOCK_NOTIFY_TRIGGER_PERSISTENT                                         \
  0x02 // The registration will remain active until it is explicitly disabled or
       // removed.
#define SOCK_NOTIFY_TRIGGER_LEVEL                                              \
  0x04 // The registration is for level-triggered notifications.
#define SOCK_NOTIFY_TRIGGER_EDGE                                               \
  0x08 // The registration is for edge-triggered notifications.
...
DWORD
WSAAPI
ProcessSocketNotifications(_In_ HANDLE completionPort,
                           _In_ UINT32 registrationCount,
                           _Inout_updates_opt_(registrationCount)
                               SOCK_NOTIFY_REGISTRATION *registrationInfos,
                           _In_ UINT32 timeoutMs, _In_ ULONG completionCount,
                           _Out_writes_to_opt_(completionCount,
                                               *receivedEntryCount)
...
inline UINT32
SocketNotificationRetrieveEvents(_In_ OVERLAPPED_ENTRY *notification) {
