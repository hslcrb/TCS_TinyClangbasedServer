...
#pragma warning(disable                                                        \
                : 4574) // #define FOO; #if FOO -- did you mean #ifdef FOO?
...
#pragma prefast(disable : 24002,                                               \
                "This code requires explicit usage of IPv4 address types.")
#endif
...
WINSOCK_API_LINKAGE
INT WSAAPI getaddrinfo(_In_opt_ PCSTR pNodeName, _In_opt_ PCSTR pServiceName,
                       _In_opt_ const ADDRINFOA *pHints,
                       _Outptr_ PADDRINFOA *ppResult);

#if (NTDDI_VERSION >= NTDDI_WINXPSP2) || (_WIN32_WINNT >= 0x0502)
WINSOCK_API_LINKAGE
INT WSAAPI GetAddrInfoW(_In_opt_ PCWSTR pNodeName, _In_opt_ PCWSTR pServiceName,
...
typedef INT(WSAAPI *LPFN_GETADDRINFO)(_In_opt_ PCSTR pNodeName,
                                      _In_opt_ PCSTR pServiceName,
                                      _In_opt_ const ADDRINFOA *pHints,
                                      _Outptr_ PADDRINFOA *ppResult);

typedef INT(WSAAPI *LPFN_GETADDRINFOW)(_In_opt_ PCWSTR pNodeName,
...
typedef void(CALLBACK *LPLOOKUPSERVICE_COMPLETION_ROUTINE)(
    _In_ DWORD dwError, _In_ DWORD dwBytes, _In_ LPWSAOVERLAPPED lpOverlapped);
...
INT WSAAPI GetAddrInfoExA(
    _In_opt_ PCSTR pName, _In_opt_ PCSTR pServiceName, _In_ DWORD dwNameSpace,
    _In_opt_ LPGUID lpNspId, _In_opt_ const ADDRINFOEXA *hints,
    _Outptr_ PADDRINFOEXA *ppResult, _In_opt_ struct timeval *timeout,
...
INT WSAAPI GetAddrInfoExW(
    _In_opt_ PCWSTR pName, _In_opt_ PCWSTR pServiceName, _In_ DWORD dwNameSpace,
...
WINSOCK_API_LINKAGE
INT WSAAPI GetAddrInfoExCancel(_In_ LPHANDLE lpHandle);

WINSOCK_API_LINKAGE
INT WSAAPI GetAddrInfoExOverlappedResult(_In_ LPOVERLAPPED lpOverlapped);
...
typedef INT(WSAAPI *LPFN_GETADDRINFOEXA)(
    _In_ PCSTR pName, _In_opt_ PCSTR pServiceName, _In_ DWORD dwNameSpace,
    _In_opt_ LPGUID lpNspId, _In_opt_ const ADDRINFOEXA *hints,
    _Outptr_ PADDRINFOEXA *ppResult, _In_opt_ struct timeval *timeout,
    _In_opt_ LPOVERLAPPED lpOverlapped,
    _In_opt_ LPLOOKUPSERVICE_COMPLETION_ROUTINE lpCompletionRoutine,
...
typedef INT(WSAAPI *LPFN_GETADDRINFOEXW)(
    _In_ PCWSTR pName, _In_opt_ PCWSTR pServiceName, _In_ DWORD dwNameSpace,
    _In_opt_ LPGUID lpNspId, _In_opt_ const ADDRINFOEXW *hints,
    _Outptr_ PADDRINFOEXW *ppResult, _In_opt_ struct timeval *timeout,
    _In_opt_ LPOVERLAPPED lpOverlapped,
    _In_opt_ LPLOOKUPSERVICE_COMPLETION_ROUTINE lpCompletionRoutine,
...
typedef INT(WSAAPI *LPFN_GETADDRINFOEXCANCEL)(_In_ LPHANDLE lpHandle);
...
INT WSAAPI SetAddrInfoExA(
    _In_ PCSTR pName, _In_opt_ PCSTR pServiceName,
    _In_opt_ SOCKET_ADDRESS *pAddresses, _In_ DWORD dwAddressCount,
    _In_opt_ LPBLOB lpBlob, _In_ DWORD dwFlags, _In_ DWORD dwNameSpace,
    _In_opt_ LPGUID lpNspId, _In_opt_ struct timeval *timeout,
    _In_opt_ LPOVERLAPPED lpOverlapped,
    _In_opt_ LPLOOKUPSERVICE_COMPLETION_ROUTINE lpCompletionRoutine,
    _Out_opt_ LPHANDLE lpNameHandle);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                   \
...
INT WSAAPI SetAddrInfoExW(
    _In_ PCWSTR pName, _In_opt_ PCWSTR pServiceName,
    _In_opt_ SOCKET_ADDRESS *pAddresses, _In_ DWORD dwAddressCount,
    _In_opt_ LPBLOB lpBlob, _In_ DWORD dwFlags, _In_ DWORD dwNameSpace,
    _In_opt_ LPGUID lpNspId, _In_opt_ struct timeval *timeout,
    _In_opt_ LPOVERLAPPED lpOverlapped,
...
#if (NTDDI_VERSION >= NTDDI_WINXPSP2) || (_WIN32_WINNT >= 0x0502)
WINSOCK_API_LINKAGE
VOID WSAAPI FreeAddrInfoW(_In_opt_ PADDRINFOW pAddrInfo);
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef VOID(WSAAPI *LPFN_FREEADDRINFO)(_In_opt_ PADDRINFOA pAddrInfo);
...
WINSOCK_API_LINKAGE
void WSAAPI FreeAddrInfoEx(_In_opt_ PADDRINFOEXA pAddrInfoEx);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP |                       \
          WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_GAMES) */
#pragma endregion

WINSOCK_API_LINKAGE
void WSAAPI FreeAddrInfoExW(_In_opt_ PADDRINFOEXW pAddrInfoEx);
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                         \
                            WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_GAMES)
typedef void(WSAAPI *LPFN_FREEADDRINFOEXA)(_In_ PADDRINFOEXA pAddrInfoEx);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP |                   \
          WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_GAMES) */
#pragma endregion

typedef void(WSAAPI *LPFN_FREEADDRINFOEXW)(_In_ PADDRINFOEXW pAddrInfoEx);
...
WINSOCK_API_LINKAGE
INT WSAAPI getnameinfo(_In_reads_bytes_(SockaddrLength)
                       ...
                       _In_ DWORD ServiceBufferSize, _In_ INT Flags);

#if (NTDDI_VERSION >= NTDDI_WINXPSP2) || (_WIN32_WINNT >= 0x0502)
WINSOCK_API_LINKAGE
INT WSAAPI GetNameInfoW(_In_reads_bytes_(SockaddrLength)
                            const SOCKADDR *pSockaddr,
                        _In_ socklen_t SockaddrLength,
                        _Out_writes_opt_(NodeBufferSize) PWCHAR pNodeBuffer,
                        _In_ DWORD NodeBufferSize,
                        _Out_writes_opt_(ServiceBufferSize)
...
PCSTR
WSAAPI
inet_ntop(_In_ INT Family, _In_ const VOID *pAddr,
          _Out_writes_(StringBufSize) PSTR pStringBuf,
          _In_ size_t StringBufSize);

PCWSTR
WSAAPI
InetNtopW(_In_ INT Family, _In_ const VOID *pAddr,
...
#if INCL_WINSOCK_API_TYPEDEFS
typedef INT(WSAAPI *LPFN_INET_PTONA)(_In_ INT Family, _In_ PCSTR pszAddrString,
                                     _Out_writes_bytes_(sizeof(IN6_ADDR))
                                         PVOID pAddrBuf);

typedef INT(WSAAPI *LPFN_INET_PTONW)(_In_ INT Family, _In_ PCWSTR pszAddrString,
                                     _Out_writes_bytes_(sizeof(IN6_ADDR))
                                         PVOID pAddrBuf);

typedef PCSTR(WSAAPI *LPFN_INET_NTOPA)(_In_ INT Family, _In_ PVOID pAddr,
                                       _Out_writes_(StringBufSize)
                                           PSTR pStringBuf,
                                       _In_ size_t StringBufSize);

typedef PCWSTR(WSAAPI *LPFN_INET_NTOPW)(_In_ INT Family, _In_ PVOID pAddr,
                                        _Out_writes_(StringBufSize)
                                            PWSTR pStringBuf,
                                        _In_ size_t StringBufSize);
...
WS2TCPIP_INLINE
char *gai_strerrorA(_In_ int ecode) {
...
WS2TCPIP_INLINE
WCHAR *gai_strerrorW(_In_ int ecode) {
  ...
  (void)FormatMessageW(FORMAT_MESSAGE_FROM_SYSTEM |
                           ...
                           FORMAT_MESSAGE_MAX_WIDTH_MASK,
                       NULL, ecode, MAKELANGID(LANG_NEUTRAL, SUBLANG_DEFAULT),
                       (LPWSTR)buff, GAI_STRERROR_BUFFER_SIZE, NULL);
...
WS2TCPIP_INLINE
int setipv4sourcefilter(_In_ SOCKET Socket, _In_ IN_ADDR Interface,
                        _In_ IN_ADDR Group, _In_ MULTICAST_MODE_TYPE FilterMode,
  ...
  Error = WSAIoctl(Socket, SIOCSIPMSFILTER, Filter, Size, NULL, 0, &Returned,
                   NULL, NULL);
...
_Success_(return == 0) WS2TCPIP_INLINE
    int getipv4sourcefilter(_In_ SOCKET Socket, _In_ IN_ADDR Interface,
                            _In_ IN_ADDR Group,
...
WS2TCPIP_INLINE
int setsourcefilter(_In_ SOCKET Socket, _In_ ULONG Interface,
                    _In_ CONST SOCKADDR *Group, _In_ int GroupLength,
                    _In_ MULTICAST_MODE_TYPE FilterMode, _In_ ULONG SourceCount,
                    _In_reads_(SourceCount)
  ...
  Error = WSAIoctl(Socket, SIOCSMSFILTER, Filter, Size, NULL, 0, &Returned,
                   NULL, NULL);
...
_Success_(return == 0) WS2TCPIP_INLINE
    int getsourcefilter(_In_ SOCKET Socket, _In_ ULONG Interface,
                        _In_ CONST SOCKADDR *Group, _In_ int GroupLength,
                        _Out_ MULTICAST_MODE_TYPE *FilterMode,
                        _Inout_ ULONG *SourceCount,
                        _Out_writes_(*SourceCount)
...
WS2TCPIP_INLINE
int idealsendbacklogquery(_In_ SOCKET s, _Out_ ULONG *pISB) {
  DWORD bytes;

  return WSAIoctl(s, SIO_IDEAL_SEND_BACKLOG_QUERY, NULL, 0, pISB, sizeof(*pISB),
                  &bytes, NULL, NULL);
}

WS2TCPIP_INLINE
int idealsendbacklognotify(_In_ SOCKET s, _In_opt_ LPWSAOVERLAPPED lpOverlapped,
                           _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE
                               lpCompletionRoutine) {
  DWORD bytes;

  return WSAIoctl(s, SIO_IDEAL_SEND_BACKLOG_CHANGE, NULL, 0, NULL, 0, &bytes,
...
WS2TCPIP_INLINE
INT WSAGetIPUserMtu(_In_ SOCKET Socket, _Out_ DWORD *Mtu) {
  ...
  Error =
      getsockopt(Socket, SOL_SOCKET, SO_PROTOCOL_INFO, (PCHAR)&Info, &InfoSize);
...
WS2TCPIP_INLINE
INT WSASetIPUserMtu(_In_ SOCKET Socket, _In_ DWORD Mtu) {
  WSAPROTOCOL_INFOW Info;
  INT InfoSize = sizeof(Info);
  INT Error;
  ...
  if (Error != SOCKET_ERROR) {
    if (Info.iAddressFamily == AF_INET) {
      ...
      Error = setsockopt(Socket, IPPROTO_IPV6, IPV6_USER_MTU, (PCHAR)&Mtu,
                         sizeof(Mtu));
#endif //(_WIN32_WINNT >= 0x0501)
    } else {
      Error = SOCKET_ERROR;
...
WS2TCPIP_INLINE
INT WSAGetFailConnectOnIcmpError(_In_ SOCKET Socket, _Out_ DWORD *Enabled) {
...
WS2TCPIP_INLINE
INT WSASetFailConnectOnIcmpError(_In_ SOCKET Socket, _In_ DWORD Enabled) {
  return setsockopt(Socket, IPPROTO_TCP, TCP_FAIL_CONNECT_ON_ICMP_ERROR,
                    (CHAR *)&Enabled, sizeof(Enabled));
}

WS2TCPIP_INLINE
INT WSAGetIcmpErrorInfo(_In_ SOCKET Socket, _Out_ ICMP_ERROR_INFO *Info) {
  INT Error;
...
WS2TCPIP_INLINE
INT WSAGetUdpSendMessageSize(_In_ SOCKET Socket, _Out_ DWORD *MsgSize) {
...
WS2TCPIP_INLINE
INT WSASetUdpSendMessageSize(_In_ SOCKET Socket, _In_ DWORD MsgSize) {
  return setsockopt(Socket, IPPROTO_UDP, UDP_SEND_MSG_SIZE, (PCHAR)&MsgSize,
                    sizeof(MsgSize));
}

WS2TCPIP_INLINE
INT WSAGetUdpRecvMaxCoalescedSize(_In_ SOCKET Socket,
...
WS2TCPIP_INLINE
INT WSASetUdpRecvMaxCoalescedSize(_In_ SOCKET Socket,
...
WS2TCPIP_INLINE
INT WSAGetRecvIPEcn(_In_ SOCKET Socket, _Out_ DWORD *Enabled) {
  WSAPROTOCOL_INFOW Info;
  INT InfoSize = sizeof(Info);
  INT OptSize = sizeof(*Enabled);
  INT Error;
  ...
  if (Error != SOCKET_ERROR) {
    if (Info.iAddressFamily == AF_INET) {
      ...
      Error = getsockopt(Socket, IPPROTO_IPV6, IPV6_RECVECN, (PCHAR)Enabled,
                         &OptSize);
#endif //(_WIN32_WINNT >= 0x0501)
    } else {
      Error = SOCKET_ERROR;
...
WS2TCPIP_INLINE
INT WSASetRecvIPEcn(_In_ SOCKET Socket, _In_ DWORD Enabled) {
  WSAPROTOCOL_INFOW Info;
  INT InfoSize = sizeof(Info);
  INT Error;
  ...
  if (Error != SOCKET_ERROR) {
    if (Info.iAddressFamily == AF_INET) {
      Error = setsockopt(Socket, IPPROTO_IP, IP_RECVECN, (PCHAR)&Enabled,
                         sizeof(Enabled));
#if (_WIN32_WINNT >= 0x0501)
    } else if (Info.iAddressFamily == AF_INET6) {
      Error = setsockopt(Socket, IPPROTO_IPV6, IPV6_RECVECN, (PCHAR)&Enabled,
                         sizeof(Enabled));
#endif //(_WIN32_WINNT >= 0x0501)
    } else {
      Error = SOCKET_ERROR;
...
WS2TCPIP_INLINE
INT WSAGetReceivedProcessorOption(_In_ SOCKET Socket, _Out_ BOOLEAN *Enabled) {
  INT OptSize = sizeof(*Enabled);
  return getsockopt(Socket, SOL_SOCKET, SO_RECEIVED_PROCESSOR, (PCHAR)Enabled,
                    &OptSize);
}

WS2TCPIP_INLINE
INT WSASetReceivedProcessorOption(_In_ SOCKET Socket, _In_ BOOLEAN Enabled) {
  return setsockopt(Socket, SOL_SOCKET, SO_RECEIVED_PROCESSOR, (PCHAR)&Enabled,
                    sizeof(Enabled));
}
...
INT WSAAPI WSASetSocketSecurity(
    _In_ SOCKET Socket,
    _In_reads_bytes_opt_(SecuritySettingsLen)
        const SOCKET_SECURITY_SETTINGS *SecuritySettings,
    _In_ ULONG SecuritySettingsLen, _In_opt_ LPWSAOVERLAPPED Overlapped,
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE CompletionRoutine);

WINSOCK_API_LINKAGE
INT WSAAPI WSAQuerySocketSecurity(
    _In_ SOCKET Socket,
    _In_reads_bytes_opt_(SecurityQueryTemplateLen)
        const SOCKET_SECURITY_QUERY_TEMPLATE *SecurityQueryTemplate,
    _In_ ULONG SecurityQueryTemplateLen,
    _Out_writes_bytes_to_opt_(*SecurityQueryInfoLen, *SecurityQueryInfoLen)
        SOCKET_SECURITY_QUERY_INFO *SecurityQueryInfo,
    _Inout_ ULONG *SecurityQueryInfoLen, _In_opt_ LPWSAOVERLAPPED Overlapped,
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE CompletionRoutine);

WINSOCK_API_LINKAGE
INT WSAAPI WSASetSocketPeerTargetName(
    _In_ SOCKET Socket,
    _In_reads_bytes_(PeerTargetNameLen)
        const SOCKET_PEER_TARGET_NAME *PeerTargetName,
    _In_ ULONG PeerTargetNameLen, _In_opt_ LPWSAOVERLAPPED Overlapped,
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE CompletionRoutine);
...
INT WSAAPI WSADeleteSocketPeerTargetName(
    ...
    _In_ ULONG PeerAddrLen, _In_opt_ LPWSAOVERLAPPED Overlapped,
    _In_opt_ LPWSAOVERLAPPED_COMPLETION_ROUTINE CompletionRoutine);

WINSOCK_API_LINKAGE
INT WSAAPI WSAImpersonateSocketPeer(_In_ SOCKET Socket,
                                    _In_reads_bytes_opt_(PeerAddrLen)
